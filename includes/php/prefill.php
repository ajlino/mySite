...
// Note: the name of the table must be formatted year_month (no leading 0). Exp: 2020_8
...
$sql = "SHOW TABLES LIKE '$tableName'"; //note SQL syntax the table name must be in quotes
$result = mysqli_query($conn, $sql);
if (!$result || mysqli_num_rows($result) == 0){ //mysqli_num_rows returns false if nothing found
  // echo $tableName;
